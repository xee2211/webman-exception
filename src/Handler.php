...
class Handler extends ExceptionHandler
{
    ...
    {
        //第三方推送数据
        $this->notifyData = $this->responseData;
        $this->notifyData['error_message'] = $this->errorMessage;
        $this->notifyData['error_trace'] = explode("\n", $e->getTraceAsString());
        $this->notifyData['file'] = $e->getFile();
        $this->notifyData['line'] = $e->getLine();
